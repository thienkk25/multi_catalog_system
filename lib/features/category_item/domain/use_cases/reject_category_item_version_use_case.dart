...
class RejectCategoryItemVersionUseCase {
  final CategoryItemVersionRepository repository;

  RejectCategoryItemVersionUseCase({required this.repository});

  Future<Either<Failure, CategoryItemVersionEntry>> call({
    required String id,
    required String rejectReason,
  }) {
    return repository.rejectVersion(id: id, rejectReason: rejectReason);
  }
}
