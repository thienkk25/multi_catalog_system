...
import 'package:multi_catalog_system/features/home/presentation/widgets/infor_card_widget.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Tra cứu Danh mục'), centerTitle: true),
      drawer: DrawerWidget(),
      body: SafeArea(
...
class LockupCatalog extends StatelessWidget {
  const LockupCatalog({super.key});
