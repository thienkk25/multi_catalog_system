...
class CategoryGroupFormPage extends StatefulWidget {
  final CategoryGroupFormType mode;
  final String? id;
  const CategoryGroupFormPage({super.key, required this.mode, this.id});
...
class _CategoryGroupFormPageState extends State<CategoryGroupFormPage> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<CategoryGroupBloc, CategoryGroupState>(
