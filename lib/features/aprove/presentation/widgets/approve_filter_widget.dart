...
class ApproveFilterWidget extends StatefulWidget {
  final VoidCallback onClose;
  const ApproveFilterWidget({super.key, required this.onClose});

  @override
  State<ApproveFilterWidget> createState() => _ApproveFilterWidgetState();
}

class _ApproveFilterWidgetState extends State<ApproveFilterWidget> {
  String _sortBy = 'created_at';
  String _sort = 'desc';

  late final CategoryItemVersionBloc _itemBloc;
  ...
  void initState() {
    super.initState();
    _itemBloc = context.itemVersionBloc;
